...
if __name__ == '__main__':
    ...
    print(client.pub_search('201909',['ECSE-200-001','ECSE-200-003','ECSE-222-001','ECSE-222-003','ECSE-223-001','ECSE-223-002','MATH-240-002','MATH-262-002','MATH-262-005','MATH-263-001','MATH-263-003'],fmt='calendar'))
